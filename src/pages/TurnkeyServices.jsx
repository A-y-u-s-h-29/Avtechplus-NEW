    ...
    <section className="bg-white py-16 md:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-1/3">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 uppercase exo leading-none mb-6">
              Turnkey{" "}
              <span className="text-orange-500 text-outline">
                Services
              </span>
            </h2>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              AVtech Plus LLP provides comprehensive{" "}
              <strong>Turnkey Solutions</strong> that integrate design,
              engineering, and execution management. By acting as a single
              point of responsibility, we accelerate value creation for our
              clients.
            </p>
        ...
        <div className="mt-20 pt-12 border-t border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-4">
            <h6 className="font-black text-gray-900 uppercase text-sm tracking-tighter">
              Instrumental Value Creation
            </h6>

            <p className="text-gray-500 text-sm leading-relaxed">
              Our turnkey model ensures that every aspect—from soil embankment
              and bulk material supply to Site-Mix-Concrete (SMC)—is managed
              under a unified governance structure. We don't just build; we
              optimize the entire commercial ecosystem of the project.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              By combining technical precision with professional management,
              we provide turnkey services for diverse sectors including
              Education (School Buildings), Health (Hospitals), and Power
              (GIS Substations). Our expertise in EPC mode allows us to
              navigate complex regulatory landscapes with ease.
            </p>
          </div>
        </div>
      </div>
